...
CONFIG = {
    ...
    "max_price": 12.000,  # Maximum allowed live_price for candidate bets.
    ...
    "weight_speed_rating": 0.300,  # Weight for the condition-aware speed rating component.
    "weight_recent_form": 0.200,  # Weight for the recent run form component.
    "weight_suitability": 0.150,  # Weight for the distance/track/condition fit component.
    "weight_connections": 0.100,  # Weight for the horse-jockey pairing history component.
    "weight_market_sanity": 0.050,  # Inverse-price tie-breaker weight.
    "weight_margin": 0.080,  # Weight for recent winning/beaten margins.
